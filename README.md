...
- **Annotated Output** — Returns an image with damage areas highlighted in real time.
...
4. Run the app with `python app.py` — the API will be available at `localhost:8000`.
